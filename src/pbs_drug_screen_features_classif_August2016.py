...
baseOutDir = '/share/data40T/aschoenauer/drug_screen/results_August_2016/separated_classifier'

# settings for scripts
baseScriptDir = '/cbio/donnees/twalter/src/drug_screen/scripts'
scriptPrefix = 'drug_screen_new'

# settingsfile
#settingsFilename = '/cbio/donnees/aschoenauer/projects/drug_screen/settings/drug_screen_features_classif.conf'
settingsFilename = '/cbio/donnees/twalter/src/drug_screen/cecog_settings/drug_screen_settings_dynseg_cluster.conf'
