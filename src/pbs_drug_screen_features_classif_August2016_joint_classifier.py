...
"""
# data directories
baseInDir = '/share/data40T/aschoenauer/drug_screen/data_offset_corrected'
baseOutDir = '/share/data40T/aschoenauer/drug_screen/results_August_2016/joint_classifier'

# settings for scripts
baseScriptDir = '/cbio/donnees/twalter/src/drug_screen/scripts/joint_cl'
scriptPrefix = 'drugs_joint_cl'

# settingsfile
#settingsFilename = '/cbio/donnees/aschoenauer/projects/drug_screen/settings/drug_screen_features_classif.conf'
settingsFilename = '/cbio/donnees/twalter/src/drug_screen/cecog_settings/drug_screen_settings_dynseg_combined_classifier_cluster.conf'
